...
$consultadisp= "SELECT ID_SMOKING, NOMBRE, DESCRIPCION, PRECIO, DESCUENTO FROM cueros where disponibilidad>=1";
...
?>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="img/productos/we.jfif" class="bd-placeholder-img card-img-top" width="100%" height="225">
            <div class="card-body">
              <p class="card-text">Smoking Paper Mantra con sabor a chicle</p>
